...
import 'package:thermal_printer/esc_pos_utils_platform/src/capability_profile.dart' as esc;
import 'package:thermal_printer/esc_pos_utils_platform/src/generator.dart' as esc;
import 'package:thermal_printer/esc_pos_utils_platform/src/enums.dart' as esc;
import 'package:thermal_printer/esc_pos_utils_platform/src/pos_column.dart' as esc;
import 'package:thermal_printer/esc_pos_utils_platform/src/pos_styles.dart' as esc;
...
// Row 2 → OrderID & Type
  ...
  for (final item in CartManager.cartItems) {
    ...
    for (final m in modifiers) {
      final modifierText =
          "   + ${m.name}".padRight(32) +
              (m.price as num).toStringAsFixed(2).padLeft(8);
    ...
    for (final a in addons) {
      final addonText =
          "   + ${a.name}".padRight(32) +
              (a.price as num).toStringAsFixed(2).padLeft(8);
