...
class TextConstants {
  // Build #1.0.7 , Naveen - added TextConstants and SharedPreferenceTextConstants classes
  ...
  static const String layoutSelectionHeader =
      "Layout selection for navigation bar and order panel";
  static const String layoutNavLeftOrderRight =
      "Navigation at left & Orders at right";
  static const String layoutNavRightOrderLeft =
      "Navigation at right & Orders at left";
  static const String layoutNavBottomOrderLeft =
      "Navigation at bottom & Orders at left";
  static const String layoutNavBottomOrderRight =
      "Navigation at bottom & Orders at right";
  ...
  static const String deleteConfirmText =
      "Do you want to delete this tab permanently?";
  ...
  static const String emailConfiguration =
      "Email service is yet to be configured";
  ...
  static const String ebtPayment = "EBT Payment";
  ...
  static const String partialPaymentText =
      "Please pay the remaining amount in  the next transaction.";
  static const String successPaymentText =
      "Please collect the remaining amount to complete the transaction.";
  static const String exitConfirmText =
      "If you go back now, the current billing session may be lost. Please confirm before exiting.";
  static const String successPaymentTitle =
  ...
  static const String receiptTitle =
      "Please choose how you'd like to share it.";
  ...
  static const String discountNotAppliedDescription =
      "The discount couldn’t be applied. Please double-check the eligibility criteria.";
  ...
  static const String closeShiftWarningDesc =
  ...
  static const String removeSpecialOrderItemDescription =
      "This action cannot be undone. The item will return to its original price.";
  static const String remove = "Remove";
  static const String close = "Close";
  static const String areYouSure = "Are you sure ?";
  static const String deleteTheRecordsDescription =
      "Do you want to really delete the records? This process cannot be undone.";
  ...
  static const String customItemAlertDescription =
      "You're about to add a custom item. Make sure the item details are accurate before proceeding.";
  ...
  static const String couponNotAppliedDescription =
      "The coupon couldn’t be applied. Please double-check the eligibility criteria or try a different code.";
  static const String invalidDiscount = "Invalid Discount";
  static const String invalidDiscountDescription =
      "The discount entered is not valid. Please review the discount details.";
  static const String customItemCouldNotBeAdded =
  ...
  static const String customItemCouldNotBeAddedDescription =
      "Do you want to add it as a custom item for this order?";
  ...
  static const String areYouSureExitShiftDescription =
      "Are you sure you want to exit the shift screen?";
  ...
  static const String searchHint =
      "Search Items"; // Build #1.0.13: updated to here
  static const String serverIdNotFound =
      "Server Order ID not found"; // Build #1.0.13: updated to here
  static const String failedToUpdateOrder =
      "Failed to update order"; // Build #1.0.13: updated to here
  static const String doYouWantTo =
      "Do you want to?"; // Build #1.0.13: updated to here
  static const String swipeToCloseShift =
      "Swipe to Close Shift"; // Build #1.0.13: updated to here
  static const String verifyDrawerAndSafeAmounts =
      "Verify Drawer & Safe Amounts";
  ...
  static const String ShiftStartDescription =
      "Once you've entered and verified the opening cash amounts, click start shift to begin transactions.";
  static const String ShiftCloseDescription =
      "Make sure all amounts are tallied accurately. Click close shift to logout and end your shift";

  static const String noPrinter = "No printer selected";
  static const String voidConfirmTitle =
      "Transaction Void Confirmation ?"; // Build #1.0.49
  static const String voidConfirmText =
      "This will cancel all items and payments in the current sale. The transaction will be recorded as voided in your sales history.";
  ...
  static const String navShiftHistory =
  ...
  static const String shiftSubTitle =
  ...
  static const String safeTotalAmount =
      "Total Amount of money in the form of notes and coins from tubes.";
  static const String updateShift = 'Update';
  static const String updateShiftDescription =
      'Please verify the drawer and safe amounts to update.';
  ...
  static const String ageRestrictedKey =
      'age_restricted'; //Build #1.0.234: Added
  static const String noSubcategoriesAvailable = 'No subcategories available';

  //Build #1.0.54: added
  static const String allStatus =
      "pending, processing, on-hold, completed, cancelled, refunded, failed";
  static const String processing = "processing";
  static const String orderScreenStatus =
  ...
  static const String failedToAddItemToFastKey =
      'Failed to add item to fast key';
  static const String failedToDeleteProductFromFastKey =
      'Failed to delete product from fast key';
  ...
  static const String pleaseStartShiftBeforeCreatingOrder =
      'Please start your shift before creating an order';
  ...
  static const String failedToFetchOrders =
      'Failed to fetch orders'; // Build #1.0.149
  ...
  static const String canNotSendEmail =
      "Invalid order ID. Cannot send email."; // Build #1.0.159
  static const String failedSendEmail = "Failed to send email";
  static const String failedToLogout =
      "Failed to logout. Please try again."; // Build #1.0.163
  ...
  static const String failedToLogin =
      "Login failed. Please try again."; // Build #1.0.166
  ...
  static const String orderPending =
      "Order changed to 'Pending'"; // Build #1.0.175: Added

  static const String cashDrawerIsOpening = "Opening Cash Drawer.";

  static const String invalidDiscountError =
      "Please enter a valid Discount"; // Build #1.0.181
  ...
  static const String couponAlreadyApplied =
  ...
  static const String payoutAlreadyAdded =
      "A payout has already been added for this order";
  static const String payoutAddedSuccess = "Payout added successfully";

  static const String unAuthMessage =
  ...
  // Build #1.0.248
  static const String failedToStartShift =
      'Failed to start shift. Please try again.';
  static const String failedToUpdateShift =
      'Failed to update shift. Please try again.';
  static const String failedCloseShift =
...
class SharedPreferenceTextConstants {
  ...
  static const String navLeftOrderRight =
      'NavLeftOrderRight'; //Build #1.0.54: added
