  ...
  void addItem(CartItem item) {
    ...
    if (existingIndex >= 0) {
      ...
      _items[existingIndex] = CartItem(
        ...
        autoDiscount: existing.autoDiscount,
        comboDiscount: existing.comboDiscount,
        multipackDiscount: existing.multipackDiscount,
        mixmatchDiscount: existing.mixmatchDiscount,
