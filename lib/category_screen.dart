...
class _FoodUiScreenState extends State<FoodUiScreen> {
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 0), // 🔥 SPACE BEFORE DIVIDER
  ...
  Widget _promoCard() {
    ...
    return SizedBox(
      width: screenWidth,
      height: bannerHeight.clamp(120.0, 120.0),
      child: ClipRRect(
          ...
          Row(
            children: List.generate(orderTypes.length, (index) {
              ...
              if (selected) {
                switch (index) {
                  case 0:
                    backgroundColor = const Color(0xFFF1C73C);
                    borderColor = const Color(0xFFF1C73C);
                    break;
              ...
              return GestureDetector(
                ...
                child: SizedBox(
                  ...
                  child: _capsule(
                    ...
                    height: filterHeight - 8, // Reduce height
                    ...
                    child: Row(
                      ...
                      children: [
                        if (index != 0) ...[
                          Icon(
                            Icons.circle,
                            size: fontSize - 2, // Slightly smaller icon
                            color: selected
                                ? Colors.white
                                : index == 1
                                ? Colors.green
                        ...
                        Flexible(
                          child: Text(
                            ...
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: fontSize - 1, // Slightly smaller text
            ...
            child: Container(
              ...
              child: ListView.separated(
                ...
                padding: EdgeInsets.only(
                  ...
                  bottom: Responsive.h(context) * 0.15,
                ),
  ...
  Widget _capsule({
    ...
    double? width,
    double? height,
    Color color = Colors.white, // <-- Added
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: borderColor,
          width: 1.0, // Increase border thickness
        ),
